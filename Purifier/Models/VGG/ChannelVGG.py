...
class Conv_FC_Block(tnn.Module):
    ...
    def __init__(self, chann_in, chann_out, k_size, p_size,i):
        ...
        if config['Global']['dataset'] == 'GTSRB':
            self.fc = tnn.Linear(self.channel_out, 43)
        else:
...
class VGG16_channel(tnn.Module):
    def __init__(self, num_classes=10):
        super(VGG16_channel, self).__init__()
...
def channel_vgg16(**kwargs):
    return VGG16_channel(**kwargs)
